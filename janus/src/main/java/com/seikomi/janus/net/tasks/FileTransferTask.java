 ...
 *
 */
public class FileTransferTask extends JanusTask {
	...
	/**
	 * Construct a data transfert task associated with the Janus server to send the
	 * files referenced by their file names if {@code isDownloadTransfert} is
	 * {@code true}, receive the files otherwise.
	 * 
	 * @param fileNames
	 *            an array of file names of files to transmit
	 * @param isDownloadTransfert
	 *            flag to indicate the direction of the data transfer : {@code true}
	 *            for sending and {@code false} to receiving.
	 * @param dataPort the data port
	 */
	public FileTransferTask(String[] fileNames, boolean isDownloadTransfert, int dataPort, String receptionDirectory) {
	...
	/**
	 * Sends the file locate to {@code path} on file system on data port channel in
	 * binary with the following format :
